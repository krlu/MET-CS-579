...
public class EnglishNoun
{
    ...
    {  word = word.toLowerCase();
        ...
        else if (word.charAt(word.length()-1) != 's') return false;
        else if (irregularSingulars.containsKey(word)) return false;
        else return word.charAt(word.length() - 2) != 's';
    }
    ...
    private static HashMap<String, java.io.Serializable> irregularSingulars = new HashMap<>(100);
    private static HashMap<String, java.io.Serializable> irregularPlurals = new HashMap<>(100);
    static
    {
